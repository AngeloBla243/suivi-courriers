...
<head>
    <meta charset="utf-8" />
    <title>Liste des courriers expédition</title>
    <style>
        @page {
...
<body>
    ...
    <div class="dgda-entete">
        ...
        <div class="entete-texts">
            ...
            <div class="dgda-service">Liste centralisée des courriers expédition</div>
        </div>
    </div>


    <h2 style="color:#1f94d2;font-size:1.17em;margin:1.4em 0 .8em;">Liste des courriers expédition</h2>
    ...
    <div class="pdf-footer">
        Kinshasa/Gombe – {{ date('d/m/Y') }} – Secrétariats de la DGDA
    </div>
</body>
