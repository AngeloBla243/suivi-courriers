...
@section('content_header')
    <h1 class="fw-bold mb-4" style="color:#1f94d2!important;">
        <i class="fas fa-print me-2"></i> Impression courrier expédition
    </h1>
@stop
...
@section('content')
    ...
    <div class="print-card">
        <h2 class="fw-bold text-primary mb-4">
            <i class="fas fa-paper-plane me-2"></i>{{ $courrier->concerne }}
        </h2>

        <div class="info-row">
            <span class="info-label"><i class="fas fa-user-tie me-1"></i>Destinataire :</span> {{ $courrier->destinataire }}
        </div>
        <div class="info-row">
        ...
        <div class="info-row">
            <span class="info-label"><i class="fas fa-hashtag me-1"></i>Référence :</span> {{ $courrier->num_reference }}
        </div>
        <div class="info-row">
